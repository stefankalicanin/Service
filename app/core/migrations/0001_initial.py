# Generated by Django 3.2.18 on 2023-05-18 16:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('DIAGNOSTIC', 'Diagnostic'), ('REPAIR', 'Repair')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repairer_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.repairerprofile')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('location', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.location')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField()),
                ('diagnostic_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.diagnosticsrequest')),
                ('schedule_appointment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.scheduleappointment')),
            ],
        ),
        migrations.CreateModel(
            name='Pricing',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.scheduleappointment'),
        ),
        migrations.AddField(
            model_name='diagnosticsrequest',
            name='user',
